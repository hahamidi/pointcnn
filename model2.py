...
class POINTCNN_SEG_attention(torch.nn.Module):
    def __init__(self, num_classes):
        ...
        #attention Q,K,V
        self.Q = nn.Conv1d(1024, 1024, kernel_size=1)
        self.K = nn.Conv1d(1024, 1024, kernel_size=1)
        self.V = nn.Conv1d(1024, 1024, kernel_size=1)
    ...
    def forward(self,points):
        ...
        out_batch = torch.zeros(self.batch_size,self.num_classes,pos4.shape[0]) 
        out = x4.T
